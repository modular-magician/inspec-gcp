...
## Examples
```
describe google_storage_bucket(project: 'chef-gcp-inspec', name: 'gcp-inspec-storage-bucket') do
  it { should exist }
...
describe google_storage_bucket(project: 'chef-gcp-inspec', name: "nonexistent") do
  it { should_not exist }
end
```
