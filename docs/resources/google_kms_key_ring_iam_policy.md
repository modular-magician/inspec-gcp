...
## Examples
```
describe google_kms_key_ring_iam_policy(["project", "location", "key_ring_name"]) do
  it { should exist }
end

google_kms_key_ring_iam_policy(["project", "location", "key_ring_name"]).bindings.each do |binding|
  describe binding do
