...
## Examples
```
describe google_kms_crypto_key_iam_policy(["project", "location", "key_ring_name", "crypto_key_name"]) do
  it { should exist }
end

google_kms_crypto_key_iam_policy(["project", "location", "key_ring_name", "crypto_key_name"]).bindings.each do |binding|
  describe binding do
